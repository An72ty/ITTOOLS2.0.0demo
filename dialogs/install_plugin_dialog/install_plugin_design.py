...
# Form implementation generated from reading ui file 'install_plugin_design.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../images/icons/download.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
