...
# Form implementation generated from reading ui file 'remove_plugin_design.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../images/icons/remove.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
